...
func TestNewBuyOrderBook(t *testing.T) {
	amountDenom, priceDenom := types.GenPair()
	book := types2.NewBuyOrderBook(amountDenom, priceDenom)
...
func TestBuyOrderBook_RemoveOrderFromID(t *testing.T) {
	...
	inputBook := types.OrderListToBuyOrderBook(inputList)
	expectedList := []types.Order{
		{ID: 3, Creator: types2.MockAccount("3"), Amount: 2, Price: 10},
		{ID: 1, Creator: types2.MockAccount("1"), Amount: 200, Price: 20},
		{ID: 0, Creator: types2.MockAccount("0"), Amount: 50, Price: 25},
	}
	expectedBook := types.OrderListToBuyOrderBook(expectedList)
...
func simulateLiquidateFromBuyOrder(
	...
	inputBook := types.OrderListToSellOrderBook(inputList)
	expectedBook := types.OrderListToSellOrderBook(expected.Book)
	require.True(t, sort.IsSorted(inputBook))
	require.True(t, sort.IsSorted(expectedBook))

	outputBook, remaining, liquidated, purchase, match, filled := types2.LiquidateFromBuyOrder(inputBook, inputOrder)
...
func TestLiquidateFromBuyOrder(t *testing.T) {
	...
	inputOrder := types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 100, Price: 10}
	_, _, _, _, match, _ := types2.LiquidateFromBuyOrder(types.SellOrderBook{
		Orders: []types.Order{},
	}, inputOrder)
	...
	inputOrder = types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 20, Price: 30}
	expected := liquidateBuyRes{
		Book: []types.Order{
			{ID: 0, Creator: types2.MockAccount("0"), Amount: 50, Price: 25},
			{ID: 1, Creator: types2.MockAccount("1"), Amount: 200, Price: 20},
			{ID: 2, Creator: types2.MockAccount("2"), Amount: 10, Price: 15},
		},
		Remaining:  types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 0, Price: 30},
		Liquidated: types.Order{ID: 2, Creator: types2.MockAccount("2"), Amount: 20, Price: 15},
		Purchase:   uint32(20),
		Match:      true,
		Filled:     true,
	}
	...
	expected = liquidateBuyRes{
		...
		Remaining:  types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 0, Price: 30},
		Liquidated: types.Order{ID: 2, Creator: types2.MockAccount("2"), Amount: 30, Price: 15},
		Purchase:   uint32(30),
		Match:      true,
		Filled:     true,
	}
	...
	inputOrder = types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 60, Price: 30}
	expected = liquidateBuyRes{
		Book: []types.Order{
			{ID: 0, Creator: types2.MockAccount("0"), Amount: 50, Price: 25},
			{ID: 1, Creator: types2.MockAccount("1"), Amount: 200, Price: 20},
		},
		Remaining:  types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 30, Price: 30},
		Liquidated: types.Order{ID: 2, Creator: types2.MockAccount("2"), Amount: 30, Price: 15},
		Purchase:   uint32(30),
		Match:      true,
		Filled:     false,
...
func simulateFillBuyOrder(
	...
	outputBook, remaining, liquidated, purchase, filled := types2.FillBuyOrder(inputBook, inputOrder)
...
func TestFillBuyOrder(t *testing.T) {
	...
	// Empty book
	inputOrder := types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 30, Price: 10}
	expected := fillBuyRes{
		Book:       []types.Order{},
	...
	expected = fillBuyRes{
		...
		Remaining: types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 30, Price: 18},
		Liquidated: []types.Order{
			{ID: 2, Creator: types2.MockAccount("2"), Amount: 30, Price: 15},
		},
		Purchase:   uint32(30),
	...
	expected = fillBuyRes{
		Book: []types.Order{
			{ID: 0, Creator: types2.MockAccount("0"), Amount: 50, Price: 25},
			{ID: 1, Creator: types2.MockAccount("1"), Amount: 170, Price: 20},
		},
		Remaining: types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 0, Price: 22},
		Liquidated: []types.Order{
			{ID: 2, Creator: types2.MockAccount("2"), Amount: 30, Price: 15},
			{ID: 1, Creator: types2.MockAccount("1"), Amount: 30, Price: 20},
		},
	...
	inputOrder = types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 300, Price: 30}
	expected = fillBuyRes{
		Book: []types.Order{},
		Remaining: types.Order{ID: 10, Creator: types2.MockAccount("1"), Amount: 20, Price: 30},
		Liquidated: []types.Order{
			{ID: 2, Creator: types2.MockAccount("2"), Amount: 30, Price: 15},
			{ID: 1, Creator: types2.MockAccount("1"), Amount: 200, Price: 20},
			{ID: 0, Creator: types2.MockAccount("0"), Amount: 50, Price: 25},
